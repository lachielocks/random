      ...
      <div className="max-w-5xl mx-auto px-6 py-16">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-500 max-w-xl mx-auto leading-relaxed">
            Silly tools, funny generators, and pointless diversions. Nothing here is particularly important. That&apos;s the point.
          </p>
        </div>
            ...
            {tools.map((tool) => (
              ...
              >
                ...
                <div className="mt-4 flex items-center text-sm font-semibold text-gray-700 group-hover:text-gray-900">
                  Open <span className="ml-1 group-hover:translate-x-1 transition-transform">→</span>
                </div>
              </Link>
            ))}
          </div>
